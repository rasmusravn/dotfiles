return {
    ...
    opts = {
        ...
        note_id_func = function(title)
            -- Create note IDs in a Zettelkasten format with a specific datetime format prefix and a suffix.
            -- In this case, a note with the title 'My new note' will be given an ID that looks
            -- like '202403051230-my-new-note', assuming the note was created on March 5, 2024, at 12:30.
            local prefix = os.date("%Y%m%d%H%M") -- Get the current datetime in YYYYMMDDHHMM format.
            local suffix = ""
            if title ~= nil then
